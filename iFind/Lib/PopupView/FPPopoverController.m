...
-(void)addObservers
{
    ...
    [[NSNotificationCenter defaultCenter]
     addObserver:self
     selector:@selector(dismissPopupTableview:)
     name:@"DismissPopoverAnimated"
     object:nil];
...
-(id)initWithViewController:(UIViewController*)viewController
{
    ...
    if(self)
    {
        ...
        self.contentSize = CGSizeMake(viewController.view.frame.size.width, viewController.view.frame.size.height); //default size
...
-(void)dismissPopupTableview:(NSNotification *)notification
{
    BOOL shouldDismiss = (BOOL)[notification object];
    [self dismissPopoverAnimated:shouldDismiss];
}
